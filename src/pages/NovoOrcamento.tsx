...
export default function NovoOrcamento() {
  ...
  return (
    <Layout>
      ...
      <div className="bg-[var(--navy2)] border border-[var(--border)] rounded-xl p-5 mb-6 max-w-3xl">
      ...
      <div className="bg-[var(--navy2)] border border-[var(--border)] rounded-xl p-5 max-w-3xl">
        <h2 className="text-[var(--text)] text-sm font-semibold uppercase tracking-wide mb-4">
